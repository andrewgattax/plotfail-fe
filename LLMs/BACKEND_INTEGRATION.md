...
**CRITICAL: This app was generated by Figma. All data is currently mocked. Your job is to refactor it to connect to the real backend following these rules exactly.**

**For general development patterns (UI components, routing, styling), see [dev_guidelines.md](./dev_guidelines.md)**
